...
// Poké Balls
    ...
    [ITEM_SPORT_BALL] =
    {
        ...
        .price = (I_PRICE <= GEN_3 || I_PRICE >= GEN_9) ? 50 : 300,
        .description = COMPOUND_STRING(
            "A special Ball\n"
            "used in the Bug-\n"
            "Catching Contest."),
...
// Medicine
    ...
    [ITEM_HYPER_POTION] =
    {
        ...
        .price = (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 120 : 150,
        .holdEffectParam = 120,
        .description = COMPOUND_STRING(
            "Restores the HP of\n"
            "a Pokémon by\n"
...
// Evolution Items
    ...
    [ITEM_DRAGON_SCALE] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 200 * TREASURE_FACTOR : 210,
        .holdEffectParam = 10,
        .description = COMPOUND_STRING(
            "A strange scale\n"
            "held by Dragon-\n"
    ...
    [ITEM_PROTECTOR] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 200 * TREASURE_FACTOR : 2100,
        .description = COMPOUND_STRING(
            "Loved by a certain\n"
            "Pokémon. It's stiff\n"
            "and heavy."),
...
// Gems
    #if I_PRICE >= GEN_9
        #define GEM_PRICE 500
    #elif I_PRICE >= GEN_7
        #define GEM_PRICE 400
    #else
        #define GEM_PRICE 20
    #endif
