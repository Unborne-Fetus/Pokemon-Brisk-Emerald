...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT}
                            #if P_HISUIAN_FORMS
                                ,{EVO_ITEM, ITEM_MOON_STONE, SPECIES_SAMUROTT_HISUI}
                            #endif
                            ),
    },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_AMOONGUSS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_BRUTE_BONNET}),
    },
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_JUGULIS}),
    },
