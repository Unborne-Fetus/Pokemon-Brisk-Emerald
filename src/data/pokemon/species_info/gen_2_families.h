...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_DUDUNSPARCE_TWO_SEGMENT, CONDITIONS({IF_PID_MODULO_100_GT, 0})},
                                {EVO_LEVEL, 42, SPECIES_DUDUNSPARCE_THREE_SEGMENT, CONDITIONS({IF_PID_MODULO_100_EQ, 0})}),
    #endif
    },
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .formSpeciesIdTable = sQwilfishFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_OVERQWIL}),
    },
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_BUNDLE}),
    },
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_THORNS}),
    },
