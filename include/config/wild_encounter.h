...
// Double Wild Battles
#define WE_DOUBLE_WILD_CHANCE            35         // % chance of encountering two Pokémon in a Wild Encounter.
...
#define WE_SMART_WILD_AI_FLAG        0x4A8     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
